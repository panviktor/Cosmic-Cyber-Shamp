...
class GameSettingsScene: SKScene{
    ...
    private func load(){
        ...
        // Left Arrow
        let Larrow = SKSpriteNode(texture: Global.sharedInstance.getMainTexture(main: .Character_Menu_LeftArrow))
        ...
        // Right Arrow
        let Rarrow = SKSpriteNode(texture: Global.sharedInstance.getMainTexture(main: .Character_Menu_RightArrow))
        ...
        // Selected Char
        let selected = SKSpriteNode(texture: Global.sharedInstance.getMainTexture(main: .Character_Menu_GlowingEffect))
        ...
        // Ground Effect
        let gEffect = SKSpriteNode(texture: Global.sharedInstance.getMainTexture(main: .Character_Menu_GroundEffect))
        ...
        msgBox.texture = Global.sharedInstance.getMainTexture(main: .Character_Menu_MessageBox)
        msgBox.position.y = -screenSize.height / 2 + msgBox.size.height/2 + 5
        ...
        msgGreenButton.texture = Global.sharedInstance.getMainTexture(main: .Character_Menu_GreenButton)
        ...
        msgBlueButton.texture = Global.sharedInstance.getMainTexture(main: .Character_Menu_BlueButton)
    ...
    private func showUpgrade() -> Bool{
        ...
        // Upgrade Box
        let upgradeBox = SKSpriteNode(texture: Global.sharedInstance.getMainTexture(main: .Character_Menu_UpgradeBox))
        ...
        // Upgrade Icon Shade
        let iconShade = SKSpriteNode(texture: Global.sharedInstance.getMainTexture(main: .Character_Menu_UpgradeIconShade))
        ...
        // Upgrade Icon
        let icon = SKSpriteNode(texture: Global.sharedInstance.getMainTexture(main: .Character_Menu_UpgradeIcon))
        ...
        // Upgrade Arrow
        let arrow = SKSpriteNode(texture: Global.sharedInstance.getMainTexture(main: .Character_Menu_UpgradeArrow))
        ...
        // Upgrade Button
        let button = SKSpriteNode(texture: Global.sharedInstance.getMainTexture(main: .Character_Menu_UpgradeGreenButton))
        ...
        // Close Button
        let closeButton = SKSpriteNode(texture: Global.sharedInstance.getMainTexture(main: .Character_Menu_UpgradeCloseButton))
